    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-background pt-20">
                <section className="relative bg-secondary py-20 px-4 sm:px-6 lg:px-8">
                    <div className="relative max-w-4xl mx-auto text-center">
                        <Button onClick={() => navigate("/#hizmetler")} variant="ghost" className="sm:absolute left-0 top-0 mb-6 sm:mb-0 text-secondary-foreground/70">
                        ...
                        <h1 className="text-4xl sm:text-5xl font-heading font-bold text-secondary-foreground mt-3 mb-6">{service.title}</h1>
                        <p className="text-xl text-secondary-foreground/80 max-w-2xl mx-auto leading-relaxed">{service.description}</p>
                    </div>
                </section>

                <section className="max-w-5xl mx-auto py-16 px-4 sm:px-6 lg:px-8 space-y-12">
                    <div className="bg-card rounded-3xl p-8 sm:p-12 shadow-card border border-border/50">
                        <p className="text-lg text-muted-foreground leading-relaxed">{content?.intro ?? `${service.title} süreci kişisel ihtiyaçlarınıza göre planlanır.`}</p>
                    </div>
                        ...
                        <>
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="bg-card rounded-3xl p-8 border">
                                    <h2 className="text-2xl font-heading font-semibold mb-5">{content.whenNeeded.title}</h2>
                                ...
                                <div className="bg-card rounded-3xl p-8 border">
                                    <h2 className="text-2xl font-heading font-semibold mb-5">{content.whoCanBenefit.title}</h2>
                            ...
                            <div>
                                <h2 className="text-3xl font-heading font-semibold text-center mb-8">{content.process.title}</h2>
                            ...
                            <div>
                                <h2 className="text-3xl font-heading font-semibold text-center mb-8">Sık Sorulan Sorular</h2>
                    ...
                    <div className="rounded-3xl bg-gradient-sage p-8 sm:p-12 text-center text-primary-foreground">
                        <h2 className="text-3xl font-heading font-bold mb-3">{content?.cta.title ?? "İlk adımı birlikte planlayalım"}</h2>
                        <p className="mb-7 opacity-85">{content?.cta.description ?? "Randevu talebinizi iletin; uygun zaman için sizinle iletişime geçelim."}</p>
